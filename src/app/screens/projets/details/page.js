  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col md:ml-64 lg:ml-64 xl:ml-64">
      ...
      <div className="fixed top-0 left-0 md:left-64 lg:left-64 xl:left-64 right-0 bg-sky-500 text-white p-4 shadow-md text-center z-10">
        <h1 className="text-xl font-bold">Détails du Projet: {projectData.title}</h1>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <Card className="w-full bg-white shadow-md border-l-4 border-sky-500">
              <CardHeader className="p-4">
                <CardTitle className="text-lg font-bold text-sky-700">Tâches</CardTitle>
              </CardHeader>
              <CardContent className="p-4">
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-sky-50">
                        <TableHead className="font-bold text-sky-700 text-xs">ID</TableHead>
                        <TableHead className="font-bold text-sky-700 text-xs">Nom</TableHead>
                        <TableHead className="font-bold text-sky-700 text-xs">Statut</TableHead>
                        <TableHead className="font-bold text-sky-700 text-xs">Dates</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {Array.isArray(tasks) && tasks.length > 0 ? tasks.map((task) => {
                        ...
                        return (
                          ...
                          >
                            <TableCell className="text-xs">{task.id || 0}</TableCell>
